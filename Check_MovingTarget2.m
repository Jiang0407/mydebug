function [ret,img_edge_ret,img_region_ret]=Check_MovingTarget2(new_img0,old_img0,region)
%% 检查重叠区域是否存在运动物体 
    img_edge_ret=[];
    img_region_ret=[];
    B=ones(4);     
